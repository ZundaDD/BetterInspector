...
[CreateAssetMenu(fileName = "RandomPool", menuName = "MikanLab/随机池2")]
/// <summary>
/// 基本随机池
/// </summary>
public class RandomPool : ScriptableObject, ISerializationCallbackReceiver
{
    ...
    public void Awake()
    {
        ...
        {
            if (node.TypeName == typeof(RootNode).AssemblyQualifiedName) break;
        }
        NodeList.Add(new() { TypeName = typeof(RootNode).AssemblyQualifiedName });
    } 
